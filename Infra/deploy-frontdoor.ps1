param(
    ...
    [ValidateSet("frontdoor")][string][Parameter(Mandatory = $true, ParameterSetName = 'Default')] $productType = "",
...
if ($deploy) {
    ...
    --name $deploymentID `
    --location $location `
    --template-file ./azure-frontdoor.bicep `
    --parameters ./azure-frontdoor.bicepparam `
